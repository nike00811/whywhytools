...
def check_type(variable: Any, expected_type: type | tuple[type, ...], var_name: str = None):
    """
...
def check_list_type(variable_list: Any, expected_type: type | tuple[type, ...], var_name: str = None):
    """
